...
class MatchTTSGCustom(BaseLightningClass):
    def __init__(
        self,
        n_vocab,
        n_spks,
    ...
    def synthesise(self, x, x_lengths, n_timesteps, temperature=1.0, spks=None, length_scale=1.0):
        ...
        decoder_outputs_rotation = decoder_outputs[:, self.n_feats + self.n_blendshapes :, :]
        decoder_outputs_blendshape = decoder_outputs[:, self.n_feats : self.n_feats + self.n_blendshapes, :]
        ...
        encoder_outputs_rotation = encoder_outputs[:, self.n_feats + self.n_blendshapes :, :]
        encoder_outputs_blendshape = encoder_outputs[:, self.n_feats : self.n_feats + self.n_blendshapes, :]
        ...
        return {
            ...
            "encoder_outputs_blendshape": encoder_outputs_blendshape,
            "decoder_outputs_blendshape": decoder_outputs_blendshape,
    ...
    def forward(self, x, x_lengths, y, y_lengths, y_blendshape, y_rotation, spks=None, out_size=None, cond=None):
        """
        Computes 3 losses:
        ...
        if self.align_with_motion:
            y = pack([y, y_blendshape, y_rotation], "b * t")[0]
            mu_x_aligner = mu_x[:, : self.n_feats + self.n_blendshapes + self.n_rotations]
        else:
