...
logging.basicConfig(filename='kon_single16khz_0667.log', encoding='utf-8', level=logging.DEBUG)
...
MATCHTTSGDECA_CHECKPOINT = "logs/train/multimodal_single_verbatim_baseline/runs/2025-05-25_02-52-53/checkpoints/last.ckpt"
...
n_timestepss = [1, 2, 3, 4, 5, 10, 15, 20, 25, 50, 100, 200, 300, 400, 500]
for n_timesteps in n_timestepss:
    ## Number of ODE Solver steps
    #n_timesteps = 50

    OUTPUT_FOLDER = f"output/kon_single16khz_0667_audio_{n_timesteps}_2"
    ...
    def save_to_folder(filename: str, output: dict, folder: str):
        ...
        sf.write(folder / f'{filename}.wav', output['waveform'], 16000, 'PCM_16')
    ...
    test_data_list = []
    test_data_path = "../data/multimodal_single_kon_verbatim_DECA/test.txt"
    ...
    for data in (tqdm(test_data_list)):
        ...
        ## face
        save_to_movement_csv(data["filename"], output, f"output/kon_single16khz_0667_movement_{n_timesteps}_2")
